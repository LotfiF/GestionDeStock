     ...
     <div id="content">      
      ...
      <%@ include file="/WEB-INF/views/menu_top/topMenu.jsp" %>           
       ...
       <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800"><fmt:message code="utilisateur.nouveau" /></h1>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><fmt:message code="utilisateur.nouveau" /></h6>
            </div>
            <div class="card-body">
            <c:url value="/utilisateur/enregistrer" var="urlEnregistrer" />
              <f:form modelAttribute="utilisateur" action="${urlEnregistrer }" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group">
                     ...
                     <f:input path="prenom" class="form-control" placeholder="Prénom" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                     <label><fmt:message code="common.motDePasse" /></label>
                     <f:input path="motDePasse" class="form-control" placeholder="Mot de passe" />
                </div>
                <div class="form-group">
                     <label><fmt:message code="common.admin.actived" /></label> 
                     <f:input path="actived" class="form-control" placeholder="Activation de l'option administrateur" />
                </div>
                  <div class="form-group">
