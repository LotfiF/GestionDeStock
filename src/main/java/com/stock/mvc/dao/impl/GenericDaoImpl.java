...
public class GenericDaoImpl<E> implements IGenericDao<E> {
	...
	public E save(E entity) {
		em.persist(entity);
		return entity; /*return em.persist(entity)*/
	}
	...
	public List<E> selectAll(String sortField, String sort) {
		...
		return query.getResultList(); /*veut dire quoi sortField et sort ?*/
	}
	...
	public int findCountBy(String paramName, String paramValue) {
		...
		Query query = em.createQuery("select t from " + type.getSimpleName() + " t where " + paramName + " = :x");
		query.setParameter(paramName, paramValue); /*x au lieu du paramName ???*/
